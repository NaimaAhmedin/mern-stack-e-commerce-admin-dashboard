    ...
    try {
      ...
      const formattedOrders = ordersArray.map((order, index) => {
        ...
        const orderProducts = order.products.map((productItem) => {
          ...
          console.log('RAW PRODUCT ITEM:', JSON.stringify(productItem, null, 2));
          console.log('PRODUCT OBJECT:', JSON.stringify(productItem.product, null, 2));
        ...
        return {
          ...
          products: orderProducts, // Ensure this is correctly populated
        };
      });
